...
s.to = function(self, reverse_3f, dot_repeat_3f)
  ...
  local function cycle_through_match_groups(in2, positions_to_label, shortcuts, enter_repeat_3f)
    ...
    while loop_3f do
      ...
      _224_ = (_225_() or get_input_and_clean_up() or _226_())
      if (nil ~= _224_) then
        local input = _224_
        if not ((input == cycle_fwd_key) or (input == cycle_bwd_key)) then
          ...
          group_offset = clamp(_228_(group_offset), 0, max_offset)
  ...
  local function save_state_for(_235_)
    local _arg_236_ = _235_
    local dot_repeat = _arg_236_["dot-repeat"]
    local enter_repeat = _arg_236_["enter-repeat"]
    if new_search_3f then
      if dot_repeatable_op_3f then
        if dot_repeat then
  ...
  local function jump_and_ignore_ch2_until_timeout_21(_245_, ch2)
    ...
    if new_search_3f then
      ...
      if op_mode_3f then
        ...
        local _let_250_ = _251_()
        local start = _let_250_[1]
        local finish = _let_250_[2]
        local hl_group
  ...
  if dot_repeat_3f then
    ...
    _259_ = self["prev-dot-repeatable-search"].in1
  else
    local _260_ = get_input_and_clean_up()
    if (nil ~= _260_) then
      local in0 = _260_
      ...
      if enter_repeat_3f then
        ...
        _259_ = (self["prev-search"].in1 or _261_())
      elseif full_incl_3f then
        _259_ = get_input_and_clean_up()
      else
        _259_ = in0
      end
    else
  ...
  if (nil ~= _259_) then
    ...
    local function _267_()
      ...
      do
        ...
        echo_not_found(_269_())
      end
      return nil
    end
    _266_ = (get_match_map_for(in1, reverse_3f) or _267_())
    if ((type(_266_) == "table") and (nil ~= (_266_)[1]) and (nil ~= (_266_)[2])) then
      local ch2 = (_266_)[1]
      local pos = (_266_)[2]
        ...
        elseif (_280_ == nil) then
          ...
          if (nil ~= _282_) then
            ...
            if not empty_3f(rest) then
              ...
              local _290_ = cycle_through_match_groups(in2, positions_to_label, shortcuts, enter_repeat_3f)
